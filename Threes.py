from Combine import *
def threes(shortfall, allocations1, spaces1, backupsize=5, used5=None):
    if used5 is None:
        used5=set()
    allocations=[]
    spaces=[]
    ...
    x=combine(allocations,spaces,shortfall.copy(),backupsize,used5)
    if x[1]:
        return x
