from Threes import *
def fours(shortfall,allocations1,spaces1,backupsize=5,used5=None):
    if used5 is None:
        used5=set()
    allocations=[]
    spaces=[]
    ...
    a=threes1(shortfall.copy(),allocations,spaces,backupsize,used5)
    if a[1]:
        return a
        ...
        for j in range(len(spaces)-1,i+2,-1):
            ...
            for k in range(j-1,i+1,-1):
                ...
                for l in range(k-1,i,-1):
                    if six6==0 and backup6==0:
                        break
                    if (i not in used6 and j not in used6 and k not in used6 and l not in used6) and spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(3*max(backupsize,6)) and (six6>0 or backup6>0):
                        if spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(3*max(backupsize,6)):
                            ...
                            if six6==0 and backup6==0:
                                return fours6,init
                            trial=threes1([backup6,six6],allocations,spaces,backupsize,used6)
                            if trial[1]:
        ...
        for j in range(len(spaces)-1,i+2,-1):
            ...
            for k in range(j-1,i+1,-1):
                ...
                for l in range(k-1,i,-1):
                    if six7==0 and backup7==0:
                        break
                    if (i not in used7 and j not in used7 and k not in used7 and l not in used7) and spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(2*max(backupsize,6)+min(backupsize,6)) and (six7>0 and backup7>0):
                        if spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(2*max(backupsize,6)+min(backupsize,6)):
                            ...
                            if six7==0 and backup7==0:
                                return fours7,init1
                            trial=threes1([backup7,six7],allocations,spaces,backupsize,used7)
                            if trial[1]:
        ...
        for j in range(len(spaces)-1,i+2,-1):
            ...
            for k in range(j-1,i+1,-1):
                ...
                for l in range(k-1,i,-1):
                    if six8==0 and backup8==0:
                        break
                    if (i not in used8 and j not in used8 and k not in used8 and l not in used8) and spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(max(backupsize,6)+2*min(backupsize,6)) and (six8>0 and backup8>0):
                        if spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(max(backupsize,6)+2*min(backupsize,6)):
                            ...
                            if six8==0 and backup8==0:
                                return fours8,init2
                            trial=threes1([backup8,six8],allocations,spaces,backupsize,used8)
                            if trial[1]:
        ...
        for j in range(len(spaces)-1,i+2,-1):
            ...
            for k in range(j-1,i+1,-1):
                ...
                for l in range(k-1,i,-1):
                    if six9==0 and backup9==0:
                        break
                    if (i not in used9 and j not in used9 and k not in used9 and l not in used9) and spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(3*min(backupsize,6)) and (six9>0 or backup9>0):
                        if spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(3*max(backupsize,6)):
                            ...
                            if six9==0 and backup9==0:
                                return fours9,init3
                            trial=threes1([backup9,six9],allocations,spaces,backupsize,used9)
                            if trial[1]:
        ...
        for j in range(len(spaces)-1,i+2,-1):
            ...
            for k in range(j-1,i+1,-1):
                ...
                for l in range(k-1,i,-1):
                    if six10==0 and backup10==0:
                        break
                    if (i not in used10 and j not in used10 and k not in used10 and l not in used10) and spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(2*max(backupsize,6)) and (six10>0 or backup10>0):
                        if spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(2*max(backupsize,6)):
                            ...
                            trial=threes1([backup10,six10],allocations,spaces,backupsize,used10)
                            if trial[1]:
        ...
        for j in range(len(spaces)-1,i+2,-1):
            ...
            for k in range(j-1,i+1,-1):
                ...
                for l in range(k-1,i,-1):
                    if six11==0 and backup11==0:
                        break
                    if (i not in used11 and j not in used11 and k not in used11 and l not in used11) and spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(max(backupsize,6)+min(backupsize,6)) and (six11>0 and backup11>0):
                        if spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(max(backupsize,6)+min(backupsize,6)):
                            ...
                            trial=threes1([backup11,six11],allocations,spaces,backupsize,used11)
                            if trial[1]:
        ...
        for j in range(len(spaces)-1,i+2,-1):
            ...
            for k in range(j-1,i+1,-1):
                ...
                for l in range(k-1,i,-1):
                    if six12==0 and backup12==0:
                        break
                    if (i not in used12 and j not in used12 and k not in used12 and l not in used12) and spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(2*min(backupsize,6)) and (six12>0 or backup12>0):
                        if spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(2*min(backupsize,6)):
                            ...
                            trial=threes1([backup12,six12],allocations,spaces,backupsize,used12)
                            if trial[1]:
        ...
        for j in range(len(spaces)-1,i+2,-1):
            ...
            for k in range(j-1,i+1,-1):
                ...
                for l in range(k-1,i,-1):
                    if six13==0 and backup13==0:
                        break
                    if (i not in used13 and j not in used13 and k not in used13 and l not in used13) and spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(max(backupsize,6)) and (six13>0 or backup13>0):
                        if spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(max(backupsize,6)):
                            ...
                            trial=threes1([backup13,six13],allocations,spaces,backupsize,used13)
                            if trial[1]:
        ...
        for j in range(len(spaces)-1,i+2,-1):
            ...
            for k in range(j-1,i+1,-1):
                ...
                for l in range(k-1,i,-1):
                    if six14==0 and backup14==0:
                        break
                    if (i not in used14 and j not in used14 and k not in used14 and l not in used14) and spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(min(backupsize,6)) and (six14>0 or backup14>0):
                        if spaces[i]+spaces[k]+spaces[j]+spaces[l]>=(min(backupsize,6)):
                            ...
                            trial=threes1([backup14,six14],allocations,spaces,backupsize,used14)
                            if trial[1]:
